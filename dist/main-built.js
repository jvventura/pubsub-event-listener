...
/***/ function(module, exports, __webpack_require__) {
	...
	var pageEvents = new _event2.default('page');

	pageEvents.create('navigate', function (resolve) {
		var data = {
	...
	pageEvents.create('interval', function (resolve) {
		var data = {
			hello: 'world'
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pubsub = __webpack_require__(23);

	var _pubsub2 = _interopRequireDefault(_pubsub);

	var _check_types = __webpack_require__(77);

	var _check_types2 = _interopRequireDefault(_check_types);
	...
	*/
	 ...
	 */
		function EventDomain(domain) {
			(0, _classCallCheck3.default)(this, EventDomain);

			if (!(0, _check_types2.default)(arguments, [String])) {
	 ...
	 */
		...
		(0, _createClass3.default)(EventDomain, [{
			key: 'create',
			value: function create(name, watcher, listener) {
				if (!(0, _check_types2.default)(arguments, [String, Function, Function])) {
	 ...
	 */
	  ...
	  */
			...
			value: function publish(topic, data) {
				...
				if (typeof topic !== 'string' && (typeof data === 'undefined' ? 'undefined' : (0, _typeof3.default)(data)) !== 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function checkTypes(args, types) {
		...
		if ((typeof args === 'undefined' ? 'undefined' : (0, _typeof3.default)(args)) !== 'object' || !Array.isArray(types)) {
			return false;
		} else {
			var argsArr = [].slice.call(args);
			return argsArr.every(function (arg, index) {
				var type = types[index];
				if (!type) {
					return true;
				} else if (type.constructor == String) {
					return (typeof arg === 'undefined' ? 'undefined' : (0, _typeof3.default)(arg)) == type;
				} else {
